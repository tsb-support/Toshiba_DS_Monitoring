...
// Default directories
$config['project_name'] = 'Toshiba DS Monitoring Tool';
...
// Autodiscover by IP
$config['discovery_by_ip'] = true;// Set to true if you want to enable auto discovery by IP.
...
$config['discovery_modules']['ipv4-addresses']       = 0;
...
$config['discovery_modules']['ntp']                  = 0;
$config['discovery_modules']['loadbalancers']        = 0;
$config['discovery_modules']['mef']                  = 0;
$config['discovery_modules']['wireless']             = 0;
$config['discovery_modules']['fdb-table']            = 0;
/*
$config['discovery_modules']['ports']                = 1;
