...
function getHostOS($device)
{
    ...
    foreach ($os_defs as $os => $def) {
        if (isset($def['discovery']) && !in_array($os, $deferred_os) && !in_array($os, $custom_deferred_os)) {
    ...
    // check custom deferred os, trova sistema operativo toshiba
    foreach ($custom_deferred_os as $os) {
